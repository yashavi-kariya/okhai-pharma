...
//                                 <img src={heroProducts[activeIndex].src} alt={heroProducts[activeIndex].title}
//                                     className="max-h-full w-full object-contain bg-transparent" loading="lazy" decoding="async" />
//                             </motion.div>
//                         </AnimatePresence>
//                     </div>
//                 </motion.div>
